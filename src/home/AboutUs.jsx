        ...
        <div className='instructor-section style-2 padding-tb section-bg-ash'>
            <div className='container'>
                <div className='section-wrapper'>
                    <div className='row' g-4 justify-content-center alidn-item-center row-cols-1 row-cols-md-2 row-cols-xl-3>
                        <div className='col'>
                            {
                                countList.map((val, i) => (
                        ...
                        <div className='col'>
                            <div className='instructer-content'>
                        ...
                        <div className='col'>
                            <div className='instructer-thumb'>
